                        ...
                        <?php if(auth()->user()): ?>
                            ...
                            <div class="post bg-white mt-3 mx-3 row mx-md-4 mx-sm-5">
                                <div class="col-12 p-0 bg-white">
                                    <div class="thumbnail  col-12 col-md-12 col-lg-12 col-xl-7 float-left p-0 text-lg-center text-xl-left " onclick="window.location.href='<?php echo e(str_replace(' ','-',$article->title)); ?>'" style="cursor: pointer; background-image:url('/images/<?php echo e($article->img); ?>');-webkit-background-size: 100% auto;background-size: 100% auto; ">
                                    </div>
                                    <div class="col-12 col-md-12 col-lg-12 col-xl-5 float-left  pl-lg-2 m-0  text-lg-center text-xl-left h-100">
                                        ...
                                        <p class=" subtitle"><?php echo str_limit(strip_tags($article->body),150); ?> </p>
