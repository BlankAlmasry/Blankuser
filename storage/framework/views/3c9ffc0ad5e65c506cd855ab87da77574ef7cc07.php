                ...
                <div class="picandabout d-block d-lg-flex pb-3">
                    ...
                    <div class="w-100 px-3">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" name="name" id="name" class="form-control " disabled value="<?php echo e(auth()->user()->name); ?>">
                            </div>
                            <div class="form-group mb-0">
                                <label for="job">Job :</label>
                                <input type="text" name="job" id="job" class="form-control d-block"  value="<?php echo e(auth()->user()->job); ?>">
                            </div>
                            <div class="form-group">
                                <label for="about">About :</label>
                                <textarea type="text" name="about" id="about" rows="4" class="form-control d-block"><?php echo e(auth()->user()->about); ?></textarea>
                            </div>
                    </div>
                    </div>
                    ...
                    <div class="col-12 ">
                        <div class="five-information mt-0">
                            ...
                            <div class="form-group"><i class="fa fa-graduation-cap"></i>
                                ...
                                <input type="text" name="school" id="school" class="form-control" value="<?php echo e(auth()->user()->school); ?>" >
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row  pick-avatar">
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user2.jpg"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user1.jpg"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user3.png"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user6.png"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user1.jpg"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user6.png"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user3.png"></div>
                                <div class="col-12 col-sm-6 col-lg-3 p-0 m-0 "><img src="img/user4.png"></div>
                            </div>
                        </div>
...
<?php $__env->startSection('footer'); ?>
    ...
    <style>
        ...
        <script>
            jQuery('select option[value="<?php echo e(auth()->user()->country); ?>"]').attr("selected",true);
            ...
            jQuery(document).ready(function(){
                jQuery('#update-form').click(function(e){
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/edit-profile')); ?>",
                        type: 'POST',
                        data: {
