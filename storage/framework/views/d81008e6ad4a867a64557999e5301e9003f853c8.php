...
<?php $__env->startSection('body'); ?>
    <form action="add-article" method="post" enctype="multipart/form-data">
        ...
        <div class="container pt-3">
            ...
            <input type="text" class="form-control form-control d-inline-block w-75" name="title" id="title" required maxlength="120" placeholder="Title" >
                <button type="submit" class="btn btn-success" value="" id="formsubmit">Publish</button>
        </div>
    </div>
