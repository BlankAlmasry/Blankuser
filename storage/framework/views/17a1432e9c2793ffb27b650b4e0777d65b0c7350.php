<?php $__env->startSection('header'); ?>
    <title><?php echo e($user->name); ?> - BlankUser</title>
    <meta name="description" content="<?php echo e($user->about); ?>">
    <meta name="keywords" content="<?php echo e($user->school); ?>,<?php echo e($user->name); ?>,<?php echo e($user->job); ?>,<?php echo e($user->points); ?>">
            ...
            <?php $__env->startSection('body'); ?>
                ...
                <!-- profile -->
                    ...
                    <div class="text-center text-md-center col-11 col-md-8 col-lg-9 mt-4 bg-white pt-3 pl-lg-5 pl-sm-2 pl-md-4 mx-4 profile PageBody">
                        ...
                        <div class="<?php echo e(($user->articles->count() == 0)?'d-none':''); ?>">
