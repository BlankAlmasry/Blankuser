        ...
        <div class="text-center text-md-center col-11 col-md-8 col-lg-9 mt-4 bg-white pt-3 pl-lg-5 pl-sm-2 pl-md-4 mx-4 profile">
            <div class="picandabout d-block d-lg-flex">
                ...
                <div class="information mt-3 pl-3 pr-5 w-100">
                    ...
                    <p class="small pb-3 text-muted">#<?php echo e(auth()->user()->id); ?></p>
                    <h6 class="h6 text-muted"><?php echo e(auth()->user()->job); ?></h6>
                    <p class="text-muted pt-3 "><?php echo e(auth()->user()->about); ?></p>
            ...
            <div class="row mt-4 text-muted pl-lg-5 pl-sm-1 pl-md-3 text-center text-md-left">
                <div class="col-12 col-lg-6 ">
                    <div class="five-information">
                        <p><i class="fa fa-briefcase"></i>&nbsp;<?php echo e(auth()->user()->job); ?></p>
                        <p><i class="fa fa-graduation-cap"></i><?php echo e(auth()->user()->school); ?></p>
                        <p><i class="fa fa-map-marker"></i>&nbsp;&nbsp;<?php echo e(auth()->user()->country); ?></p>

                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="three-information">
                        <p><i class="fa fa-clock-o"></i>&nbsp;<?php echo e(\Carbon\Carbon::parse(auth()->user()->last_log_at)->diffForHumans()); ?></p>
                        <p><i class="fa fa-history"></i>&nbsp;<?php echo e(auth()->user()->created_at->diffForHumans()); ?> </p>
                        <p><i class="fa fa-pencil pr-0"></i><?php echo e(auth()->user()->articles->count()); ?> Article</p>
