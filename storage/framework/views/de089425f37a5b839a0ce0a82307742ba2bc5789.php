...
<?php $__env->startSection('body'); ?>
    <form action="\edit-article\<?php echo e($article->id); ?>" method="post" enctype="multipart/form-data "novalidate >
        <?php echo csrf_field(); ?>
                ...
                <div class="row no-gutters p-0 m-0">
                    ...
                    <div class=" col-12 col-md-3 p-0 m-0 pl-2">
                        <div class="form-group pl-2 mt-md-4">
                            ...
                            <a href="/images/<?php echo e($article->img); ?>" class="form-text text-primary">Image :<?php echo e($article->img); ?></a>
                        </div>
                        <div class="card mb-2">
