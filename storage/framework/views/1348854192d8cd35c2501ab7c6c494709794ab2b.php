                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <?php if(auth()->user()): ?>
                                    ...
                                    <button class="btn btn-secondary mt-4 mr-3 ml-auto float-right" onclick = "window.location.href='add-post.html'">Add post</button>
                                <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="post bg-white mt-3 mx-3 row mx-md-4 mx-sm-5">
                                        <div class="col-12 p-0 bg-white">
                                            <div class="thumbnail  col-12 col-md-12 col-lg-12 col-xl-7 float-left p-0 text-lg-center text-xl-left " onclick="window.location.href='<?php echo e(str_replace(' ','-',$article->title)); ?>'" style="cursor: pointer; background-image:url('http://127.0.0.1:8000/images/<?php echo e($article->img); ?>'); ">
                                            </div>
