...
<div class="d-none d-md-inline-block col-4 col-md-3 col-lg-2 target nav-section text-muted   p-0 pl-lg-3 pl-sm-0 pl-md-1" style="">
    <div class="Mytext font-weight-bold {{(
    ...
    <div class="Mytext   w-100 {{($_SERVER['REQUEST_URI'] =='/profile')?'text-black-50 active':''}} " onclick="window.location.href = '/profile'">
        <img src="/img/user2.jpg" class=" d-md-inline-block" width="20" height="20" class="d-inline align-top">
        <span>Profile</span>
    </div>
    <div class="Mytext w-100 {{($_SERVER['REQUEST_URI'] =='/my-articles')?'text-black-50 active':''}} " onclick="window.location.href = '/my-articles'" ><i class="fa fa-pencil  d-md-inline-block" ></i> My Articles</div>
    <div class="Mytext w-100 {{($_SERVER['REQUEST_URI'] =='/leaderboard')?'text-black-50 active':''}} " onclick="window.location.href = '/leaderboard'"><i class="fa fa-trophy  d-md-inline-block"></i> LeaderBoards</div><hr>
    <div class="Mytext w-100 Explore">Explore</div>
    <div class="Mytext w-100 Explore-parent pt-0 {{($_SERVER['REQUEST_URI'] =='/users')?'text-black-50 active':''}} " onclick="window.location.href = '/users'">&nbsp;&nbsp;&nbsp;&nbsp;Users</div>
    <div class="Mytext w-100 Explore-parent {{($_SERVER['REQUEST_URI'] =='/articles')?'text-black-50 active':''}} " onclick="window.location.href = '/articles'">&nbsp;&nbsp;&nbsp;&nbsp;Articles</div>
    <div class="Mytext  w-100 Explore-parent {{($_SERVER['REQUEST_URI'] =='/categories')?'text-black-50 active':''}} " onclick="window.location.href = '/categories'">&nbsp;&nbsp;&nbsp;&nbsp;Categories</div><hr>
