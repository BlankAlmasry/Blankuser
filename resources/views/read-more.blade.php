...
@section('header')
    <title>{{$article->title}} - BlankUser</title>
    <meta name="description" content="{{str_limit(trim(preg_replace('/ +/', ' ', preg_replace('/[^A-Za-z0-9]/', ' ',urldecode(html_entity_decode(strip_tags($article->body)))))),120)  }}">
